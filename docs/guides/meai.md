...
The Neural4D SDK provides integration with [Microsoft.Extensions.AI](https://learn.microsoft.com/en-us/dotnet/ai/microsoft-extensions-ai), enabling seamless interoperability with the unified .NET AI abstractions.

## Installation

```bash
dotnet add package Neural4D
```
...
using var client = new Neural4DClient(
    apiKey: Environment.GetEnvironmentVariable("NEURAL4D_API_KEY")!);
