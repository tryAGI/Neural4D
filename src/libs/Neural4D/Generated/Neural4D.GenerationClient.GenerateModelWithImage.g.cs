...
namespace Neural4D
{
    public partial class GenerationClient
    {
        ...
        private static readonly global::Neural4D.EndPointSecurityRequirement s_GenerateModelWithImageSecurityRequirement0 =
        ...
        private static readonly global::Neural4D.EndPointSecurityRequirement[] s_GenerateModelWithImageSecurityRequirements =
            new global::Neural4D.EndPointSecurityRequirement[]
            {                s_GenerateModelWithImageSecurityRequirement0,
            };
        partial void PrepareGenerateModelWithImageArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Neural4D.GenerateModelWithImageRequest request);
        partial void PrepareGenerateModelWithImageRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Neural4D.GenerateModelWithImageRequest request);
        partial void ProcessGenerateModelWithImageResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGenerateModelWithImageResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Neural4D.GenerationResponse> GenerateModelWithImageAsync(

            global::Neural4D.GenerateModelWithImageRequest request,
            global::Neural4D.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GenerateModelWithImageAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Neural4D.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Neural4D.AutoSDKHttpResponse<global::Neural4D.GenerationResponse>> GenerateModelWithImageAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareGenerateModelWithImageArguments(
            ...
            var __authorizations = global::Neural4D.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GenerateModelWithImageSecurityRequirements,
                operationName: "GenerateModelWithImageAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGenerateModelWithImageRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Neural4D.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Neural4D.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GenerateModelWithImageAsync",
                                pathTemplate: "\"/api/generateModelWithImage\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGenerateModelWithImageResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Neural4D.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGenerateModelWithImageResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::Neural4D.GenerationResponse> GenerateModelWithImageAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Neural4D.GenerateModelWithImageRequest
            {
                FileKey = fileKey,
            ...
            return await GenerateModelWithImageAsync(
                request: __request,
                requestOptions: requestOptions,
