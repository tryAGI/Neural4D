...
namespace Neural4D
{
    public partial class ImagesClient
    {
        ...
        private static readonly global::Neural4D.EndPointSecurityRequirement s_GetMattedResultSecurityRequirement0 =
        ...
        private static readonly global::Neural4D.EndPointSecurityRequirement[] s_GetMattedResultSecurityRequirements =
            new global::Neural4D.EndPointSecurityRequirement[]
            {                s_GetMattedResultSecurityRequirement0,
            };
        partial void PrepareGetMattedResultArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Neural4D.GetMattedResultRequest request);
        partial void PrepareGetMattedResultRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Neural4D.GetMattedResultRequest request);
        partial void ProcessGetMattedResultResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetMattedResultResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Neural4D.GetMattedResultResponse> GetMattedResultAsync(

            global::Neural4D.GetMattedResultRequest request,
            global::Neural4D.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetMattedResultAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Neural4D.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Neural4D.AutoSDKHttpResponse<global::Neural4D.GetMattedResultResponse>> GetMattedResultAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareGetMattedResultArguments(
            ...
            var __authorizations = global::Neural4D.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetMattedResultSecurityRequirements,
                operationName: "GetMattedResultAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Neural4D.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Neural4D.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetMattedResult",
                                methodName: "GetMattedResultAsync",
                                pathTemplate: "\"/api/getMattedResult\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetMattedResultResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Neural4D.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetMattedResultResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Neural4D.GetMattedResultResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Neural4D.AutoSDKHttpResponse<global::Neural4D.GetMattedResultResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Neural4D.GetMattedResultResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Neural4D.GetMattedResultResponse> GetMattedResultAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Neural4D.GetMattedResultRequest
            {
                RequestId = requestId,
            };

            return await GetMattedResultAsync(
                request: __request,
                requestOptions: requestOptions,
