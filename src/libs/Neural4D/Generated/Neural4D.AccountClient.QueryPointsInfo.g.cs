...
namespace Neural4D
{
    public partial class AccountClient
    {
        ...
        private static readonly global::Neural4D.EndPointSecurityRequirement s_QueryPointsInfoSecurityRequirement0 =
        ...
        private static readonly global::Neural4D.EndPointSecurityRequirement[] s_QueryPointsInfoSecurityRequirements =
            new global::Neural4D.EndPointSecurityRequirement[]
            {                s_QueryPointsInfoSecurityRequirement0,
            };
        partial void PrepareQueryPointsInfoArguments(
            global::System.Net.Http.HttpClient httpClient);
        partial void PrepareQueryPointsInfoRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage);
        partial void ProcessQueryPointsInfoResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessQueryPointsInfoResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Neural4D.QueryPointsInfoResponse> QueryPointsInfoAsync(
            global::Neural4D.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await QueryPointsInfoAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Neural4D.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Neural4D.AutoSDKHttpResponse<global::Neural4D.QueryPointsInfoResponse>> QueryPointsInfoAsResponseAsync(
            global::Neural4D.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareQueryPointsInfoArguments(
                httpClient: HttpClient);


            var __authorizations = global::Neural4D.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_QueryPointsInfoSecurityRequirements,
                operationName: "QueryPointsInfoAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Neural4D.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Neural4D.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "QueryPointsInfoAsync",
                                pathTemplate: "\"/api/queryPointsInfo\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessQueryPointsInfoResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Neural4D.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessQueryPointsInfoResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Neural4D.QueryPointsInfoResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Neural4D.AutoSDKHttpResponse<global::Neural4D.QueryPointsInfoResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Neural4D.QueryPointsInfoResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
