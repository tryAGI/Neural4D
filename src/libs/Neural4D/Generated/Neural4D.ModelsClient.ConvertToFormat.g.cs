...
namespace Neural4D
{
    public partial class ModelsClient
    {
        ...
        private static readonly global::Neural4D.EndPointSecurityRequirement s_ConvertToFormatSecurityRequirement0 =
        ...
        private static readonly global::Neural4D.EndPointSecurityRequirement[] s_ConvertToFormatSecurityRequirements =
            new global::Neural4D.EndPointSecurityRequirement[]
            {                s_ConvertToFormatSecurityRequirement0,
            };
        partial void PrepareConvertToFormatArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Neural4D.ConvertToFormatRequest request);
        partial void PrepareConvertToFormatRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Neural4D.ConvertToFormatRequest request);
        partial void ProcessConvertToFormatResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessConvertToFormatResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Neural4D.ConvertToFormatResponse> ConvertToFormatAsync(

            global::Neural4D.ConvertToFormatRequest request,
            global::Neural4D.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await ConvertToFormatAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Neural4D.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Neural4D.AutoSDKHttpResponse<global::Neural4D.ConvertToFormatResponse>> ConvertToFormatAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareConvertToFormatArguments(
            ...
            var __authorizations = global::Neural4D.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ConvertToFormatSecurityRequirements,
                operationName: "ConvertToFormatAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Neural4D.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Neural4D.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "ConvertToFormatAsync",
                                pathTemplate: "\"/api/convertToFormat\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessConvertToFormatResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Neural4D.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessConvertToFormatResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Neural4D.ConvertToFormatResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Neural4D.AutoSDKHttpResponse<global::Neural4D.ConvertToFormatResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Neural4D.ConvertToFormatResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Neural4D.ConvertToFormatResponse> ConvertToFormatAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Neural4D.ConvertToFormatRequest
            {
                Uuid = uuid,
                ModelType = modelType,
                ModelSize = modelSize,
            ...
            return await ConvertToFormatAsync(
                request: __request,
                requestOptions: requestOptions,
